    ...
    <div className="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark">
      <div className="aspect-[6/4] overflow-hidden rounded-lg bg-secondary pt-4 text-center dark:bg-dark-2">
        <ImageComponent
          ...
          width={500}
          height={500}
          className="inline-block scale-110 object-contain object-bottom"
        />
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          <a
            href="#"
            className="inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-primary px-6 py-4 font-medium text-white transition hover:bg-green-600 focus:outline-none focus:ring disabled:pointer-events-none disabled:opacity-50 dark:bg-green-600 dark:hover:bg-green-700"
          >
            <svg
